    ...
    return (
        <section className='mt-16'>
            <div className='container'>
                <h2 className="text-center mb-5 text-3xl font-[100]">Education</h2>
                <div className='relative'>
                    ...
                    <div className='mt-8 flex flex-col gap-16 sm:gap-10'>
                        {data.map((item, index) => {
                            return (
                                <div key={item.id} className={`flex flex-col-reverse sm:flex-row gap-8 ${index % 2 !== 0 ? 'sm:flex-row-reverse' : null}`} >
                                    ...
                                    <div className=' hidden sm:flex bg-primary h-[22px] w-[22px] rounded-full text-white shrink-0 items-center justify-center text-sm mt-1'>
                                        <MdCheck />
                                    </div>
